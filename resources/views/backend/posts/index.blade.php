              ...
              <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>@lang('dashboard.News')</h4>
                        <h4 class="nav-item ml-auto">
                        <a href="{{ route ('posts.create')  }}" class="btn btn-icon icon-left btn-success rounded-pill">
                      ...
                      <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                        ...
                        <tbody>
                          ...
                          <tr class="text-left">
                            ...
                            <td>
                                @if ($item->image)
                                    <img src="{{ asset('uploads/posts/'.$item->image) }}"  height="70" alt="{{ $item->name }}">
                                @else
                            ...
                            <td>
                                <a href="{{ route ('posts.edit',$item->id) }}" class="btn btn-icon btn-primary" data-toggle="tooltip" title="{{__('dashboard.Edit')}}">
