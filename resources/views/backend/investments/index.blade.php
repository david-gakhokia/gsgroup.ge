                      ...
                      <table class="table table-striped" id="table-2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($item->image)
                                        <img src="{{ asset('uploads/investments/'.$item->image) }}"  width="50">
                                    @else
                                ...
                                <td>
                                    {{-- <a href="{{ route('investments.show',$item->id) }}" class="btn btn-icon btn-info" data-toggle="tooltip" data-original-title="@lang('dashboard.View')">
                                        <i class="far fa-eye"></i>
                                    </a> --}}
                                    @can('client-edit')
                                    <a href="{{ route('investments.edit',$item->id) }}" class="btn btn-icon btn-primary" data-toggle="tooltip" data-original-title="@lang('dashboard.Edit')">
                                        <i class="far fa-edit"></i>
                                    </a>
                                    @endcan
                                    @can('client-delete')
                                        <form action="{{ route('investments.destroy',$item->id) }}" method="POST" >
                                        @csrf
                                        @method("DELETE")
