    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('contacts.store') }}" class="needs-validation" novalidate="" method="POST"
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="phone" name="phone" class="form-control marker" required="">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <textarea name="{{ $locale }}[address]" value="{{ old($locale . '.address') }}"
                                        class="summernote-simple">{{ old($locale . '.address') }}</textarea>
                                    <div class="invalid-feedback">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <button class="btn btn-success"><i class="far fa-paper-plane"></i>
