                ...
                <div class="page-content note-has-grid">
                  ...
                  <div class="tab-content bg-transparent">
                    <div id="note-full-container" class="note-has-grid row">
                        <form action="{{ route('lives.store') }}" class="needs-validation" novalidate="" method="POST"  enctype="multipart/form-data" >
                            @csrf
                            <div class="card-body">
                                <div class="form-row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text"  name="link" class="form-control phone-number" placeholder="მ.გ http://domain.com">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="number"  name="rank" class="form-control phone-number" placeholder="">
                                                <div class="invalid-feedback">
                                                    {{__('Opss Price is Required')}} !
                                                </div>
                                            </div>
