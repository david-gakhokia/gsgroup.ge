                ...
                <div class="page-content note-has-grid">
                  <ul class="nav nav-pills p-3 mb-3 rounded-pill align-items-center">
                    <li class="nav-item">
                      <a href="javascript:void(0)"
                        ...
                        id="all-category">
                        <i data-feather="check-circle"></i><span class="d-md-block">@lang('dashboard.Add')</span>
                      </a>
                    </li>
                  ...
                  <div class="tab-content bg-transparent">
                    <div id="note-full-container" class="note-has-grid row">
                        <form action="{{ route('exclusives.store') }}" class="needs-validation" novalidate="" method="POST"  enctype="multipart/form-data" >
                            @csrf
                            <div class="card-body">
                                <div class="form-row">
                                    @foreach(config('translatable.locales') as $locale)
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="{{ $locale }}[title]" value="{{ old($locale . '.title') }}" class="form-control marker" required="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text"  name="icon" class="form-control phone-number" placeholder="fa fas-users">
                                                <div class="invalid-feedback">
