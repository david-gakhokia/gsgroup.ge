                  ...
                  <ul class="nav nav-pills p-3 mb-3 rounded-pill align-items-center">
                    ...
                    <div class="tab-content bg-transparent">
                        <div id="note-full-container" class="note-has-grid row">
                            <form action="{{ route('visions.update',$vision->id) }}" class="needs-validation"  method="POST"  enctype="multipart/form-data" >
                                @method('PUT')
                                @csrf
                                <div class="card-body">
                                    <div class="form-row">
                                        @foreach(config('translatable.locales') as $locale)
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="{{ $locale }}[title]" value="{{ $vision->translate($locale)->title}}"
                                                        placeholder="{{ $vision->translate($locale)->title}}" class="form-control marker" required="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text"  name="icon"  value="{{ $vision->icon }}" class="form-control phone-number" placeholder="მ.გ fab fa-linkedin">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="file" name="image"   value="{{ $vision->image }}" class="form-control file">
                                                </div>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="form-group col-md-4">
                                                <label>@lang('dashboard.Image')</label>
                                                @if ($vision->image)
                                                    <img src="{{ asset('uploads/visions/'.$vision->image) }}"  width="100">
                                                @else
                                        ...
                                        @foreach(config('translatable.locales') as $locale)
                                            <div class="form-group col-md-12">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <textarea class="form-control" name="{{ $locale }}[description]">{{ $vision->translate($locale)->description}}</textarea>
                                                    <div class="invalid-feedback">
                                ...
                                <div class="card-footer text-right">
                                    ...
                                    <a href="{{ route ('visions.index') }}" class="btn btn-info">
